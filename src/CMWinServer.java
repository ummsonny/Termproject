...
public class CMWinServer extends JFrame {
	...
	private G1ServerEventHandler m_eventHandler;
	...
	CMWinServer()
	{
		...
		m_eventHandler = new G1ServerEventHandler(m_serverStub, this);
	...
	public G1ServerEventHandler getServerEventHandler()
	{
